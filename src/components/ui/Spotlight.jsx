...
// EML cyan hsl: #47C9F3 ≈ hsl(195, 88%, 62%)
const C = '195, 88%'

export function Spotlight({
  gradientFirst  = `radial-gradient(68.54% 68.72% at 55.02% 31.46%, hsla(${C}, 62%, .10) 0, hsla(${C}, 35%, .03) 50%, hsla(${C}, 45%, 0) 80%)`,
  gradientSecond = `radial-gradient(50% 50% at 50% 50%, hsla(${C}, 62%, .07) 0, hsla(${C}, 35%, .02) 80%, transparent 100%)`,
  gradientThird  = `radial-gradient(50% 50% at 50% 50%, hsla(${C}, 62%, .05) 0, hsla(${C}, 45%, .02) 80%, transparent 100%)`,
  translateY  = -350,
  width       = 560,
  height      = 1380,
  smallWidth  = 240,
...
export function GridBackground() {
  return (
    <motion.div
      ...
      style={{
        backgroundImage: `url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32' width='32' height='32' fill='none' stroke='rgb(71 201 243 / 0.04)'%3e%3cpath d='M0 .5H31.5V32'/%3e%3c/svg%3e")`,
      }}
    />
  )
}
